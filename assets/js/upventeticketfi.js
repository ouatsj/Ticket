    ...
    document.querySelectorAll('.addventeticketfi').forEach(function (e) 
    {
        document.querySelector('h3#tafiTitle').innerHTML = `VENTE DE FIDELITE`;
            ...
            arfi.onchange = () => {
                ...
                document.querySelector('#quartier4fid').options.length = 1;
                                        ...
                                        httpRequestitinefi.onload = () => {
                                                const donitinesfi = JSON.parse(httpRequestitinefi.responseText);
                                                    if(donitinesfi === null)
                                                    {
                                                        ...
                                                        document.querySelector('#quartier4fid').style.display = 'none';
                                                        ...
                                                        document.querySelector('#idquart4fid').style.display = 'none';
                                                        ...
                                                        document.querySelector('#idquartfid').style.display = 'block';
                                                        document.querySelector('#quartierfid').style.display = 'block';
                                                        ...
                                                        if (Object.entries(donitinesfi).length >= 1) 
                                                        {
                                                            ...
                                                            for (let key in Object.entries(donitinesfi)) 
                                                            {
                                                                ...
                                                                if(i === 3){
                                                                    ...
                                                                    document.querySelector('#quartier2fid').style.display = 'block';
                                                                    document.querySelector('#quartier3fid').style.display = 'block';    
                                                                    document.querySelector('#quartier4fid').style.display = 'block';    
                                                                    document.querySelector('#idquart1fid').style.display = 'block';
                                                                    document.querySelector('#idquart2fid').style.display = 'block';
                                                                    document.querySelector('#idquart3fid').style.display = 'block';
                                                                    document.querySelector('#idquart4fid').style.display = 'block';
                                                                    document.querySelector('#prix_axetransfid').style.display = 'block';
                                                                    document.querySelector('#prix_axetransfid1').style.display = 'block';
                                                                    document.querySelector('#prix_axetransitfid1').style.display = 'block';
                                                                    document.querySelector('#prix_axetransitfid').style.display = 'block';
                                                                ...
                                                                document.querySelector('#idquartfid').style.display = 'none';
                                                                document.querySelector('#quartierfid').style.display = 'none';
                                                            ...
                                                            if(i === 2)
                                                            {
                                                                ...
                                                                var typgareselfi = post_typgare1fi[1];
                                                                    ...
                                                                    httptypequart1fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifquart/${typgareselfi}`, true);
                                                                                ...
                                                                                {       
                                                                                    if (Object.entries(donitfi).length >= 1) {
                                                                                        for (let key in Object.entries(donitfi)) {
                                                                                            ...
                                                                                            document.querySelector('#programtransfid1').value = `${donitfi[key].depart_code}`;
                                                                                    ...
                                                                                    const cdprogitfinr = document.querySelector('#programtransfid1').value;
                                                                                    ...
                                                                                    const dpt_dateitinefi = document.querySelector('#date_depheurefid').value;
                                                                                        httpRequetteitfi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdisponiblebus/${cdprogitfinr}/${dpt_dateitinefi}/${lgitfi}/${timitfi}/${dbitfi}/${fnitfi}`, true);
                                                                ...
                                                                if (progsiegestransfi !== null) {
                                                                    progsiegestransfi.onchange = () => 
                                                                    {
                                                                        ...
                                                                        const prostransfi = document.querySelector('#programtransfid').value;
                                                                            const prostransfinr = document.querySelector('#programtransfid1').value;
                                                                        httpSiegestransfi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifisiegesnr/${prostransfinr}/${sigstransfi}`, true);
                                                                        httpSiegestransfi.onload = () => 
                                                                        {
                                                                            ...
                                                                            if(donsgetransfi == '')
                                                                            {
                                                                                ...
                                                                                httpSiegstransfi.open('GET', window.location.origin + `${APP_ROOT}/programmes/creersiege/${prostransfinr}/${sigstransfi}`, true);
                                                                ...
                                                                if (progcheminfi !== null) 
                                                                {
                                                                    progcheminfi.onchange = () => 
                                                                    {
                                                                        ...
                                                                        httptypequart2fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifquart/${typgaresel1fi}`, true);
                                                                                    ...
                                                                                    if (Object.entries(dongtranschemfi).length >= 1)
                                                                                        {
                                                                                            for (let key in Object.entries(dongtranschemfi)) {
                                                                                                let opt = document.createElement('option');
                                                                                                opt.value = `${dongtranschemfi[key].code_progr}/${dongtranschemfi[key].intervalle1}/${dongtranschemfi[key].intervalle2}/${dongtranschemfi[key].id_ligneheure}/${dongtranschemfi[key].prix}/${dongtranschemfi[key].depart_code}`;
                                                                    ...
                                                                    if (prochemintrafi !== null)
                                                                        ...
                                                                        {  
                                                                            ...
                                                                            var itinetrasfinr = post_transfi[5];

                                                                                httpPrixittransitefi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdispotransbus/${itinetrasfinr}`, true);
                                                                                ...
                                                                                const httpRequetteitrafi = new XMLHttpRequest();
                                                                                    ...
                                                                                    httpRequetteitrafi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdisponibletransbus/${itinetrasfinr}/${dbitrafi}/${fnitrafi}`, true);
                                                                        ...
                                                                        if (progsieges1fi !== null) 
                                                                        {
                                                                            progsieges1fi.onchange = () => 
                                                                            {
                                                                                ...
                                                                                var itinetras1finr = post_trans1fi[5];
                                                                                ...
                                                                                httpSieges1fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifisiegesnr/${itinetras1finr}/${sigs1fi}`, true);
                                                                                httpSieges1fi.onload = () => 
                                                                                {
                                                                                    ...
                                                                                    if(donsge1fi == '')
                                                                                    {
                                                                                        ...
                                                                                        httpSiegs1fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/creersiege/${itinetras1finr}/${sigs1fi}`, true);
                                                                                        httpSiegs1fi.onload = () => 
                                                                                        {
                                                            ...
                                                            if(i === 3)
                                                            {
                                                                                ...
                                                                                {       
                                                                                    if (Object.entries(donit1fi).length >= 1) {
                                                                                        for (let key in Object.entries(donit1fi)) {
                                                                                            ...
                                                                                            document.querySelector('#programtransfid1').value = `${donit1fi[key].depart_code}`;
                                                                ...
                                                                if (progsiegestransfi !== null) {
                                                                    progsiegestransfi.onchange = () => 
                                                                    {
                                                                        ...
                                                                        const prostransfi = document.querySelector('#programtransfid').value;
                                                                        const prostransfinr = document.querySelector('#programtransfid1').value;
                                                                        httpSiegestrans1fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifisiegesnr/${prostransfinr}/${sigstransfi}`, true);
                                                                ...
                                                                if (progchemin1fi !== null) 
                                                                {
                                                                    progchemin1fi.onchange = () => 
                                                                    {
                                                                        ...
                                                                        httptypequart32fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifquart/${typgaresel31fi}`, true);
                                                                                    ...
                                                                                    if (Object.entries(dongtranschem1fi).length >= 1)
                                                                                        {
                                                                                            for (let key in Object.entries(dongtranschem1fi)) {
                                                                                                let opt = document.createElement('option');
                                                                                                opt.value = `${dongtranschem1fi[key].code_progr}/${dongtranschem1fi[key].intervalle1}/${dongtranschem1fi[key].intervalle2}/${dongtranschem1fi[key].id_ligneheure}/${dongtranschem1fi[key].prix}/${dongtranschem1fi[key].depart_code}`;
                                                                    ...
                                                                    if (prochemintra1fi !== null)
                                                                        ...
                                                                        {  
                                                                            ...
                                                                            var prixtra1fi = post_trans1fi[4];
                                                                                var itinetras1finr = post_trans1fi[5];
                                                                                httpPrixittransite1fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdispotransbus/${itinetras1finr}`, true);
                                                                                ...
                                                                                const httpRequetteitra1fi = new XMLHttpRequest();
                                                                                    ...
                                                                                    httpRequetteitra1fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdisponibletransbus/${itinetras1finr}/${dbitra1fi}/${fnitra1fi}`, true);
                                                                        ...
                                                                        if (progsieges2fi !== null) 
                                                                        {
                                                                            progsieges2fi.onchange = () => 
                                                                            {
                                                                                ...
                                                                                var itinetras2fi = post_trans2fi[0];
                                                                                    var itinetras2finr = post_trans2fi[5];
                                                                                ...
                                                                                httpSieges2fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifisiegesnr/${itinetras2finr}/${sigs2fi}`, true);
                                                                                httpSieges2fi.onload = () => 
                                                                                {
                                                                                    ...
                                                                                    if(donsge2fi == '')
                                                                                    {
                                                                                        ...
                                                                                        httpSiegs2fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/creersiege/${itinetras2finr}/${sigs2fi}`, true);
                                                                                        httpSiegs2fi.onload = () => 
                                                                                        {
                                                                ...
                                                                if (progsiegestransfi !== null) {
                                                                    progsiegestransfi.onchange = () => 
                                                                    {
                                                                       ...
                                                                       const gareidentiftrans1fi = document.querySelector('#deplignetransfid').value;
                                                                        ...
                                                                        .options[document.querySelector('#psiegesitinesfid').options.selectedIndex].value;
                                                                        const prostransfi = document.querySelector('#programtransfid').value;
                                                                        const prostransfinr = document.querySelector('#programtransfid').value;
                                                                            ...
                                                                            {  
                                                                                ...
                                                                                itinetrasfinr = post_transfi[5];
                                                                                    ...
                                                                                    const httpRequetteitrafi = new XMLHttpRequest();
                                                                                        ...
                                                                                        httpRequetteitrafi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdisponibletransbus/${itinetrasfibus}/${dbitrafi}/${fnitrafi}`, true);
                                                                                    httpRequetteitrafi.onload = () => {
                                                                                        const dattaitrafi = JSON.parse(httpRequetteitrafi.responseText);
                                                                                        console.debug(`${typeof dattaitrafi} - ${dattaitrafi.attributes}`, console.memory);
                                                                                        if (Object.entries(dattaitrafi).length >= 1) {
                                                               ...
                                                               let progchemin2fi = document.querySelector('#idchemins2fid');
                                                                if (progchemin2fi !== null) 
                                                                {
                                                                    progchemin2fi.onchange = () => 
                                                                    {
                                                                        ...
                                                                        let httptypequart42fi;
                                                                        httptypequart42fi = new XMLHttpRequest();
                                                                        
                                                                        httptypequart42fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifquart/${typgaresel41fi}`, true);
                                                                        httptypequart42fi.onload = () => 
                                                                        {
                                                                            const donqua42fi = JSON.parse(httptypequart42fi.responseText);
                                                                            if (donqua42fi == '') {
                                                                                document.querySelector('#quartier4fid').options.length = 1;
                                                                            }
                                                                            else{
                                                                                if (Object.entries(donqua42fi).length >= 1) {
                                                                                                
                                                                                    for (let key in Object.entries(donqua42fi)) {
                                                                                        let optq41 = document.createElement('option');
                                                                                        optq41.value = `${donqua42fi[key].nom_quartier}`;
                                                                                        optq41.innerHTML = `${donqua42fi[key].nom_quartier}`;
                                                                                        document.querySelector('#quartier4fid').add(optq41);
                                                                                    }
                                                                                } else {
                                                                                    document.querySelector('#quartier4fid').options.length = 1;
                                                                                }
                                                                        ...
                                                                        httptypequart42fi.setRequestHeader('Content-Type', 'application/json');
                                                                        httptypequart42fi.send();
                                                                                    ...
                                                                                    if (Object.entries(dongtranschem2fi).length >= 1)
                                                                                        {
                                                                                            for (let key in Object.entries(dongtranschem2fi)) {
                                                                                                let opt = document.createElement('option');
                                                                                                opt.value = `${dongtranschem2fi[key].code_progr}/${dongtranschem2fi[key].intervalle1}/${dongtranschem2fi[key].intervalle2}/${dongtranschem2fi[key].id_ligneheure}/${dongtranschem2fi[key].prix}/${dongtranschem2fi[key].depart_code}`;
                                                                    ...
                                                                    if (prochemintra2fi !== null)
                                                                        ...
                                                                        {  
                                                                            ...
                                                                            var prixtra2fi = post_trans2fi[4];
                                                                                ...
                                                                                httpPrixittransite2fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdispotransbus/${itinetras2finr}`, true);
                                                                                ...
                                                                                const httpRequetteitra2fi = new XMLHttpRequest();
                                                                                    ...
                                                                                    httpRequetteitra2fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdisponibletransbus/${itinetras2finr}/${dbitra2fi}/${fnitra2fi}`, true);
                                                                        ...
                                                                        if (progsieges3fi !== null) 
                                                                        {
                                                                            progsieges3fi.onchange = () => 
                                                                            {
                                                                               ...
                                                                               const gareidentiftrans5fi = document.querySelector('#gidtrans2fid').value;
                                                                                ...
                                                                                var itinetras3finr = post_trans3fi[5];
                                                                                let httpSieges3fi;
                                                                                ...
                                                                                httpSieges3fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifisiegesnr/${itinetras3finr}/${sigs3fi}`, true);
                                                                                httpSieges3fi.onload = () => 
                                                                                {
                                                                                    ...
                                                                                    if(donsge3fi == '')
                                                                                    {
                                                                                        ...
                                                                                        httpSiegs3fi.open('GET', window.location.origin + `${APP_ROOT}/programmes/creersiege/${itinetras3finr}/${sigs3fi}`, true);
                                                                                        httpSiegs3fi.onload = () => 
                                                                                        {
                                                                            ...
                                                                            httpProgfi.onload = () => 
                                                                            {
                                                                                ...
                                                                                if (Object.entries(donsfi).length >= 1) {
                                                                                    for (let key in Object.entries(donsfi)) {
                                                                                        ...
                                                                                        document.querySelector('#programfid1').value = `${donsfi[key].depart_code}`;
                                                                                        ...
                                                                                        const profinr = document.querySelector('#programfid1').value;
                                                                                        httpSiegefi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifisiegesnr/${profinr}/${sigfi}`, true);
                                                                                        httpSiegefi.onload = () => 
                                                                                        {
                                                                                            ...
                                                                                            if(donsgfi == '')
                                                                                            {
                                                                                                ...
                                                                                                httpSiegfi.open('GET', window.location.origin + `${APP_ROOT}/programmes/creersiege/${profinr}/${sigfi}`, true);
                                                                                                httpSiegfi.onload = () => 
                                                                                                {
                                                        ...
                                                        {       
                                                            if (Object.entries(donfi).length >= 1) {
                                                                for (let key in Object.entries(donfi)) {
                                                                    ...
                                                                    document.querySelector('#programfid1').value = `${donfi[key].depart_code}`;
                                                            ...
                                                            const cdprogfinr = document.querySelector('#programfid1').value;
                                                            ...
                                                            const timfi = document.querySelector('#herfid').value;
                                                                ...
                                                                httpRequettefi.open('GET', window.location.origin + `${APP_ROOT}/programmes/siegdisponiblebus/${cdprogfinr}/${dpt_datefi}/${lgfi}/${timfi}/${dbfi}/${fnfi}`, true);
            ...
            if (progsiegesfi !== null) {
                progsiegesfi.onchange = () => 
                {
                    ...
                    prosfinr = document.querySelector('#programfid1').value;
                    httpSiegesfi.open('GET', window.location.origin + `${APP_ROOT}/programmes/verifisiegesnr/${prosfinr}/${sigsfi}`, true);
                    httpSiegesfi.onload = () => 
                    {
