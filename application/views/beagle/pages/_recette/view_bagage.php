...
<div class="row">
    ...
    <? foreach ($ecrivainbagages as $item): ?>
        <div class="col-lg-3">
            ...
            <div class="card card-border card-contrast">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= site_url('utilisateurs/'
                        . $this->session->company->ekey . '/profilsbagage/'
...
<!--End of file: view_bagage.php-->
<!--File location: application/views/beagle/pages/_recette/view_bagage.php-->                            