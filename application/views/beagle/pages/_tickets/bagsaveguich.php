                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                        ...
                        ?>
                          ...
                          <tr><td style="font-size: 20px;">Prix:<?= number_format($itembag->prix_bagage, 0, '', ' '); ?></td></tr>

                          <tr><td style="font-size: 20px;">Facturer le :<b><?= $day; ?></b></td></tr>
...
<!--End of file: bagsaveguich.php-->
<!--File location: application/views/beagle/pages/_tickets/bagsaveguich.php-->