                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>
                      ...
                      <? $ckey = $this->session->company->ekey;
                        ...
                        <table width="80%">
                          <tr><th style="font-size: 60px;">Expedié le</th><th style="font-size: 60px;">à</th><th style="font-size: 60px;">Client</th></tr>
                          <tr><td style="font-size: 60px;"><?= $day;?></td><td style="font-size: 60px;"><?= $single->heure; ?></td><td></td></tr>
                        ...
                        <div style="border:2px solid; margin:2px; width:90%;">
                            ...
                            <tr><th style="font-size: 60px;"><?= $exped->nom_client;?></th><th style="font-size: 60px;"> <?= $exped->prenom_client;?></th></tr>
                            <tr><th style="font-size: 60px;"><?= $exped->contact_client;?></th><th style="font-size: 60px;"><?= $exped->num_CNIB;?></th><th></th></tr>
                            <tr><th style="font-size: 60px;"><?= $exped->date_delivre;?></th><th style="font-size: 60px;"><?= $exped->lieu_delivre;?></th><th></th></tr>
                            </table>
                        </div>
                        <div style="border:2px solid; margin:2px; width:90%;">
                          ...
                          <table width="90%" style="font-size: 60px;">
                            ...
                            <tr><th style="font-size: 60px;"><?= $destin->nomprenom_perso;?></th><th></th><th style="font-size: 60px;"><?= $destin->contact_perso;?></th></tr>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>
                      ...
                      <?
                        ...
                        <h4 style="text-decoration: underline;" align="center"></h4>
                        <table width="90%">
                          <tr><th style="font-size: 60px;">Expedié le</th><th style="font-size: 60px;">à</th><th>Courrier</th></tr>
                          <tr><td style="font-size: 60px;"><?= $day;?></td><td style="font-size: 60px;"><?= $single->heure; ?></td><td></td></tr>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>
                        ...
                        $this->entreprise = $this->m_entreprises->get_key($ckey);
                          ...
                          <?
                            ...
                            for ($i=1; $i<=$j; $i++) { 
                                   $n =($i.'/'.$j);}
                        ?>
                        <tr><td style="font-size: 70px; width: 40%;"> <img src="<?echo site_url($single->logo);?>" width="850" height="3500"></td></tr>
                        <div style="border:2px solid; font-size: 60px; width: 90%;" align="center"><b>
                           C:<?= $single->num_couresc;?> <?= $n;?>
                        </div>
                        ...
                        <h4 style="text-decoration: underline;" align="center"></h4>
                        <table width="90%">
                          <tr><th style="font-size: 60px;">Expedié le</th><th style="font-size: 60px;">à</th><th style="font-size: 60px;">Archive</th></tr>
                          <tr><td style="font-size: 60px;"><?= $day;?></td><td style="font-size: 60px;"><?= $single->heure; ?></td><td></td></tr>
