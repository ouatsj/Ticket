                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          if($ressougaretra3->possitiongare === 'Maintenant'){
                            ...
                            <tr><td width="25%" style="font-size: 15px;"><?= $itemtrans3->code_ticket; ?></td><td colspan="2" align=left style="font-size: 15px;"></td><td align=center style="font-size: 12px;"><?= $item->nom_client; ?> <?= $item->prenom_client; ?></td><td align=center style="font-size: 9px;"><?= $itemtrans3->tamponcod; ?> <?= htmlspecialchars(ticket_emis_texte(isset($item) ? $item : null, $dtoday, isset($conex) ? $conex : null), ENT_QUOTES, 'UTF-8'); ?></td><td style="font-size: 9px;"></td>
                            </tr>
                            <tr><td style="font-size: 15px;"><?= $itemartrans3->codeticket; ?></td><td colspan="2" align=left style="font-size: 17px;"></td><td align=center><?= $itemtrans3->nom_ligne; ?></td><td align=left>ALLER</td><td align=left>RETOUR</td></tr>

                            <tr><td align=left style="font-size: 15px;"><?= $itemtrans3->nom_ligne; ?></td><td colspan="2" align=left style="font-size: 12px;"></td><td align=center style="font-size: 13px;">QUARTIER:<?= $itemtrans3->quart;?></td><td style="font-size: 15px;" align=left><?= $itemtrans3->code_ticket; ?></td><td style="font-size: 15px;" align=left><?= $itemartrans3->codeticket; ?></td>
                            </tr>
                            <tr><td align=left><?= $ressougaretra3->nomsousgare; ?></td><td align=left colspan="2" style="font-size: 10px;"></td><td align=center style="font-size: 12px;">PRIX: $prtr3;?></td><td align=left style="font-size: 15px;"><?= $ressougaretra3->nomsousgare; ?>:<?= $day3;?></td><td align=left style="font-size: 15px;">DATE:</td>
                            </tr>
                            ...
                            <tr><td align=left><?= $item->prenom_client; ?></td><td align=center colspan="3"> <?= ticket_barcode_img($itemtrans3->tamponcod, 200, 35); ?></td><td align=left></td>
                            </tr>
                            <tr><td align=left><?= $item->contact_client; ?></td><td colspan="3" align=center style="font-size: 8px;">Billet valable 1 mois. Billet non remboursable</td><td align=left colspan="2">CONVOCATION 45 mn avant le départ</td>
                            </tr>
                            <tr><td align=left><?= $prtr3;?> <?= $codb3;?></td><td colspan="3" align="center" style="font-size: 9px;"><?= $itemtrans3->nom_compagnie;?> décline toute responsabilité en cas de perte ou de vol de billet et de bagages même payés.</td>
                            </tr>
