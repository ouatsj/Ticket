            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                      <h1 align="left"> <?=mdate("%d/%m/%Y", now('UTC')); ?> <?= $conex->username; ?></h1><b>
                        ...
                        <h1 align="left">Arrêt du jour</h1>
                    ...
                    <h2 align="left">recette du jour :<?= number_format($montantglobal+$montantglobalr, 0, '', ' '); ?> </h2>
                    ...
                    <h1 align="left">Antérieur oublié (jours précédents)</h1>
                    <table border="1" cellpadding="0">
                        <thead>
                            <tr>
                              <th width="150px" align="left"><strong>LIGNES</strong></th>
                        ...
                        <body>
                            ...
                            ?>
                            <tr>
                              <td width="150px" align="left"><strong><?= $allerretourAnt; ?></strong></td>
                              <td width="50px" align="left"><strong><?=$repret->cod; ?></strong></td>
                              <td width="90px" align="left"><strong><?=$repret->cod ? ($repret->totalr/$repret->cod) : 0; ?></strong></td>
                              <td width="90px" align="left"><strong><?=number_format($repret->totalr, 0, '', ' '); ?></strong></td>
                            </tr>
                              <?php $montantglobal_rat += $repret->totalr; ?>
                            <?php endforeach; ?>
                        </body>
                    </table>
                    <h2 align="left">total antérieur oublié :<?= number_format($montantglobal_rat, 0, '', ' '); ?> </h2>
