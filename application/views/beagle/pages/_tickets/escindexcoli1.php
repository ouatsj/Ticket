                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>                        
                      ...
                      <?
                        ...
                        <div style="border:2px solid; font-size: 60px; width: 80%;" align="center"><b>
                        ...
                        <div style="border:2px solid; margin:2px; width:90%;">
                            ...
                            <tr><th style="font-size: 60px;"><?= $exped->nomprenom_perso;?></th><th></th><th style="font-size: 60px;"><?= $exped->contact_perso;?></th></tr>
                        ...
                        <div style="border:2px solid; margin:2px; width:90%;">
                          ...
                          <table width="90%" style="font-size: 60px;">
                            ...
                            <tr><th style="font-size: 80px;"><?= $destin->nom_client;?></th><th style="font-size: 80px;"><?= $destin->prenom_client;?></th><th style="font-size: 80px;"><?= $destin->contact_client;?></th></tr>
                          </table>
                        </div>
...
<!--End of file: escindexcoli1.php-->
<!--File location: application/views/beagle/pages/_tickets/escindexcoli1.php-->