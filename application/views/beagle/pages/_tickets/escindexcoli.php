                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>
                        ...
                        <div style="border:2px solid; margin:2px; width:90%;">
                            ...
                            <tr><th><?= $exped->nomprenom_perso;?></th><th></th><th><?= $exped->contact_perso;?></th></tr>
                            </table>
                        </div>
                        <div style="border:2px solid; margin:2px; width:90%;">
...
<!--End of file: escindexcoli.php-->
<!--File location: application/views/beagle/pages/_tickets/escindexcoli.php-->