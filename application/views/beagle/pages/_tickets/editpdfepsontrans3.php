            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                        ...
                        <?= ticket_emis_html($item, $dtoday, '15px', isset($conex) ? $conex : null); ?>
                        </table>
                    </body>
                </div>
            </div>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                       ...
                       <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($itemtrans->logo);?>" width="300" height=""></td></tr>
                        ...
                        <?= ticket_emis_html($itemtrans, $dtoday, '15px', isset($conex) ? $conex : null); ?>
                        </table>
                    </body>
                </div>
            </div>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                       ...
                       <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($itemtrans2->logo);?>" width="300" height=""></td></tr>
            							...
            							<?= ticket_emis_html($itemtrans2, $dtoday, '15px', isset($conex) ? $conex : null); ?>
                        </table>
                    </body>
                </div>
            </div>
                    ...
                    <body>
                      ...
                      <table>
                       ...
                       <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($itemtrans3->logo);?>" width="300" height=""></td></tr>
                        ...
                        <?= ticket_emis_html($itemtrans3, $dtoday, '15px', isset($conex) ? $conex : null); ?>
                        </table>
                    </body>
                </div>
            </div>
                ...
                <table>
                      ...
                      $ressougare = $this->m_gare_depart->getgar($this->entreprise->id_entreprise, $item->code_gaexp, $item->departclient_idgare, $item->ident_ligne, $item->id_ligneheure);
                        ...
                        ?>
                          ...
                          <?= ticket_stub_non_reprog_html($itemtrans3); ?>
                        </table>
                    </body>
                </div>
            </div>
...
<!--End of file: editpdfepsontrans3.php-->
<!--File location: application/views/beagle/pages/_tickets/editpdfepsontrans3.php-->