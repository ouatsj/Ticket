            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>
                      ...
                      <div style="border:2px solid; font-size: 65px; padding:2px; width: 80%;" align="center"><b>
                        Code:<?= $single->num_couresc; ?> <?= $n;?>
                      </div>
                      <h4 style="text-decoration: underline;" align="center"></h4>
                      <table>
                        <tr><th style="font-size: 60px;">Trajet:<?= $single->nom_gaep;?> (<?= $single->nomsousgare;?>)-<?= $single->nom_gadest;?> (<?= $single->quartier_courrieresc; ?>)</th></tr>
                      </table>
                        <h4 style="text-decoration: underline;" align="center"></h4>
                      <table width="80%">
                        ...
                        <div style="border:2px solid; margin:2px; width:90%;">
                          <table width="90%" style="font-size: 60px;">
                            ...
                            <tr><th><?= $exped->contact_client;?></th><th><?= $exped->num_CNIB;?></th></tr>
                            <tr><th><?= $exped->date_delivre;?></th><th><?= $exped->lieu_delivre;?></th></tr>
                          </table>
                        </div>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>
                      ...
                      <table>
                        ...
                        <h4 style="text-decoration: underline;" align="center"></h4>
                      <table width="80%">
                        <tr><th style="font-size: 60px;">Expedié le</th><th style="font-size: 60px;">à</th><th style="font-size: 60px;">Courrier</th></tr>
                        <tr><td style="font-size: 60px;"><?= $day;?></td><td style="font-size: 60px;"><?= $single->heure;?></td><td></td></tr>
                      </table>
                        <div style="border:2px solid; margin:2px; width:90%;">
                          <table width="90%" style="font-size: 60px;">
...
<!--End of file: escindexcoli3.php-->
<!--File location: application/views/beagle/pages/_tickets/escindexcoli3.php-->