                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                      ...
                      function int2str($a)
                      {
                        ...
                        <tr><td align=left style="font-size: 15px;"> <?= $itemrecu->nom_ligne; ?></td></td><td colspan="3" align=left style="font-size: 15px;"></td><td align=center style="font-size: 15px;"><?= $itemrecu->nom_ligne; ?></td>
                        </tr>
                        <tr><td align=left>Somme de:<?= int2str($itemrecu->prixvente); ?> (<?= number_format($itemrecu->prixvente, 0, '', ' ') ; ?> F CFA)</td><td colspan="3" align=left></td><td align=center style="font-size: 15px;">Somme de:<?= int2str($itemrecu->prixvente); ?> (<?= number_format($itemrecu->prixvente, 0, '', ' ') ; ?> F CFA)</td>
                        </tr>
...
<!--End of file: editrecus.php-->
<!--File location: application/views/beagle/pages/_tickets/editrecus.php-->