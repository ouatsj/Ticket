                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                      ...
                      $sg_label = ($ressougare && !empty($ressougare->nomsousgare))
                        ...
                        <tr><td align=left style="font-size: 9px;"><?= $item->tamponcod;?>&nbsp;&nbsp;&nbsp; CONFIRMER</td><td colspan="3" align=center style="font-size: 9px;">Suivez et surveillez bien vos bagages</td>
                        </tr>
                        <tr><td align=left style="font-size: 9px;"></td><td colspan="3" align=center style="font-size: 9px;">BON VOYAGE AVEC <?= $item->nom_compagnie;?>&nbsp;&nbsp;&nbsp;<?= $nge;?> &nbsp;&nbsp;&nbsp;CONFIRMER</td>
...
<!--End of file: editpdfconf.php-->
<!--File location: application/views/beagle/pages/_tickets/editpdfconf.php-->