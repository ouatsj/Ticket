                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <body>
                        ...
                        <table>
                          ...
                          $ressougare = $this->m_gare_depart->getgar($this->entreprise->id_entreprise, $item->code_gaexp, $item->departclient_idgare, $item->ident_ligne, $item->id_ligneheure, $item->id_ligneheure);
                          ...
                          <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($item->logo);?>" width="300" height=""></td></tr>
                            ...
                            <tr><td style="font-size: 40px; width: 100%;"> <?= ticket_barcode_img($item->tamponcod, 250, 40); ?></td></tr>
                    ...
                    <body>
                      ...
                      <table>
                          ...
                          <tr><td style="font-size: 20px;"><b><?= str_pad($item->num_siege_categorie, 2, "0", STR_PAD_LEFT); ?></b></td></tr>
						              <tr><td style="font-size: 20px;"><?= number_format(ticket_impression_prix($item)+ticket_impression_prix($item), 0, '', ' '); ?> &nbsp;FCFA &nbsp;<?= "{$item->contact_client}"; ?></td></tr>
                    ...
                    <table>
                          ...
                          if($ressougaretra->possitiongare === 'Maintenant'){
                            ...
                            if($ressougaretra->possitiongare === 'Apres'){
                              ...
                              <tr><td style="font-size: 20px;">Heure_depart:</td></tr>
                              <tr><td style="font-size: 20px;">Siege:</td></tr>
                              <tr><td style="font-size: 20px;"><?= number_format(ticket_impression_prix($itemtrans), 0, '', ' '); ?> FCFA</td></tr>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($itemtrans2->logo);?>" width="300" height=""></td></tr>
          							  ...
          							  <tr><td style="font-size: 20px;">Prix :<?= number_format(ticket_impression_prix($itemtrans2)+ticket_impression_prix($itemtrans2), 0, '', ' '); ?> &nbsp;FCFA &nbsp;<?= "{$item->contact_client}"; ?></td></tr>
          								<tr><td>ALLER-RETOUR</td></tr>
                        </table>
                    </body>
                </div>
                      ...
                      <? $ckey = $this->session->company->ekey;
                       $this->entreprise = $this->m_entreprises->get_key($ckey);
                          ...
                          if($ressougaretra3->possitiongare === 'Maintenant'){
                            ...
                            <tr><td style="font-size: 40px; width: 100%;"> <?= ticket_barcode_img($itemtrans3->tamponcod, 250, 40); ?></td></tr>
                            <tr><td style="font-size: 15px;">emis : <?= $dtoday; ?></td></tr>
                        </table>
                    </body>
                </div>
                        ...
                        $ressougare = $this->m_gare_depart->getgar($this->entreprise->id_entreprise, $item->code_gaexp, $item->departclient_idgare, $item->ident_ligne, $item->id_ligneheure);
                          ...
                          if($ressougaretra3->possitiongare === 'Maintenant'){
                            ...
                            <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($itemtrans3->logo);?>" width="300" height=""></td></tr>
                              ...
                              <tr><td style="font-size: 30px;">Siege:</td></tr>
                              <tr><td style="font-size: 30px;"><?= number_format(ticket_impression_prix($itemtrans3), 0, '', ' '); ?> FCFA&nbsp;<?= $item->contact_client; ?></td></tr>
                              <tr><td style="border:2px solid; font-size: 23px;"><b>N° BUS :...... </b></td></tr>
                              <tr><td>CONVOCATION 45 mn avant le départ</td></tr>
                              <tr><td style="font-size: 9px;">Billet valable 1 mois. Billet non remboursable</td></tr>
                              <tr><td style="font-size: 9px;"><?= $itemtrans3->nom_compagnie;?> décline toute responsabilité en cas de</td></tr>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                         ...
                         <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($itemtrans3->logo);?>" width="300" height=""></td></tr>
                          ...
                          <tr><td style="font-size: 20px;"><?= number_format(ticket_impression_prix($itemtrans3)+ticket_impression_prix($itemtrans3), 0, '', ' '); ?> &nbsp;FCFA &nbsp;<?= "{$item->contact_client}"; ?></td></tr>
                            <tr><td>ALLER-RETOUR</td></tr>
                        </table>
                    </body>
                </div>
