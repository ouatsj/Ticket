                    ...
                    <body>
                      ...
                      <table>
                        ...
                        $tim1 = date('H', time('H'));
                          ...
                          ?>
                          <tr><td style="font-size: 70px; width: 40%;"> <img src="<?echo site_url($itembags3->logo);?>" width="850" height="350"></td></tr>
                          <tr><td style="font-size: 65px;"><b>Reçu N° : <?= str_pad($itembags3->id_bagage, 3, "0", STR_PAD_LEFT); ?></b></td></tr>
                          <tr><td style="font-size: 60px;"><?= "{$itembags3->nom_gaep}"; ?> <?= "{$ressougare3->nomsousgare}"; ?>-<?= "{$itembags3->nom_gadest}"; ?></td></tr>
                          <tr><td style="font-size: 65px;">Contact exp:<?= $itembags3->contactexpedi; ?> <?= $itembags3->genrebagage; ?></td></tr>
                          <tr><td style="font-size: 65px;">Contact dest:<?= $itembags3->contact_client; ?></td></tr>
                          <tr><td style="font-size: 65px;"> <?= $itembags3->nom_client; ?> <?= $itembags3->prenom_client; ?></td></tr>
                          <tr><td style="font-size: 65px;">Nombre bagage:<?= $itembags3->nombrebagage; ?>&nbsp;(<?=$itembags3->typebagages; ?>)</td></tr>
                          <tr><td style="font-size: 65px;">Contenu:<?= $itembags3->contenubagage; ?></td></tr>
                          <tr><td style="font-size: 65px;">Valeur:<?= $itembags3->valeurbagage; ?>FCFA</td></tr>
                          <tr><td style="font-size: 65px;"><b><?= $day3; ?>&nbsp;&nbsp; <?= $heures3; ?></b></td></tr>
                          <tr><td style="font-size: 65px;">Prix:<?= number_format($itembags3->prix_bagage, 0, '', ' '); ?> &nbsp;FCFA </td></tr>
                          <tr><td style="font-size: 40px;">emis : <?= $dtoday3; ?> &nbsp;par <?= $itembags3->username; ?> code <?= $itembags3->codebag; ?></td></tr>
                          <tr><td style="font-size: 40px;"><?= $itembags3->nom_compagnie;?> décline toute responsabilité en cas de</td></tr>
                          <tr><td style="font-size: 40px;">perte ou de vol de billet et de bagages même payés.</td></tr>
                          <tr><td style="font-size: 40px;">Suivez et surveillez bien vos bagages</td></tr>
                          <tr><td style="font-size: 50px;">BON VOYAGE AVEC <?= $itembags3->nom_compagnie;?></td></tr>
                        </table>
                    </body>
                </div>
            </div>
                    ...
                    <body>
                      ...
                      <table>
                        ...
                        $this->entreprise = $this->m_entreprises->get_key($ckey);
                         ...
                         $ressougare4 = $this->m_gare_depart->getgar($this->entreprise->id_entreprise, $itembags4->code_gaexp, $itembags4->idsgarebag , $itembags4->ident_ligne, $itembags4->id_ligneheure);

                        if($ressougare4->possitiongare === 'Maintenant'){

                              $g4 = explode(":", $itembags4->heure);
                              $gt4 = (($g4[0] * 60) + $g4[1] + $ressougare4->minutetemps); 
                              $heur4 = ($gt4 / 60); 
                              $secondes4 = round($gt4 % 60);
                            $heures4 = sprintf("%02d:%02d", $heur4, $secondes4);
                              
                        }

                        if($ressougare4->possitiongare === 'Avant'){
                              $g4 = explode(":", $itembags4->heure);
                              $gt4 = (($g4[0] * 60) + $g4[1] - $ressougare4->minutetemps); 
                              $heur4 = ($gt4 / 60); 
                              $secondes4 = round($gt4 % 60);
                        ...
                        if($ressougare4->possitiongare === 'Apres'){
                              $g4 = explode(":", $itembags4->heure);
                              $gt4 = (($g4[0] * 60) + $g4[1] + $ressougare4->minutetemps); 
                              $heur4 = ($gt4 / 60); 
                              $secondes4 = round($gt4 % 60);
                        ...
                        $tim1 = date('H', time('H'));
                          ...
                          if($tim1 === '00')
                          {
                              $dats4 = date('01:00:00', time('01:00:00'));
                          }
                          else
                          {
                              $dats4 = date('H:i:s', time('H:i:s'));
                          }

                          $key1 = mdate("%Y-%m-%d", now());
                          $dtoday4 = $key1.' à '.$dats4;
                          
                          $dat4 = explode("-", $itembags4->date_progr);
                          $day4 = $dat4[2]. '-'. $dat4[1]. '-' .$dat4[0];
                          ?>
                          <tr><td style="font-size: 70px; width: 40%;"> <img src="<?echo site_url($itembags4->logo);?>" width="850" height="350"></td></tr>
                          <tr><td style="font-size: 65px;"><b>Reçu N° : <?= str_pad($itembags4->id_bagage, 3, "0", STR_PAD_LEFT); ?></b></td></tr>
                          <tr><td style="font-size: 60px;"><?= "{$itembags4->nom_gaep}"; ?> <?= "{$ressougare4->nomsousgare}"; ?>-<?= "{$itembags4->nom_gadest}"; ?></td></tr>
                          <tr><td style="font-size: 65px;">Contact exp:<?= $itembags4->contactexpedi; ?> <?= $itembags4->genrebagage; ?></td></tr>
                          <tr><td style="font-size: 65px;">Contact dest:<?= $itembags4->contact_client; ?></td></tr>
                          <tr><td style="font-size: 65px;"> <?= $itembags4->nom_client; ?> <?= $itembags4->prenom_client; ?></td></tr>
                          <tr><td style="font-size: 65px;">Nombre bagage:<?= $itembags4->nombrebagage; ?>&nbsp;(<?=$itembags4->typebagages; ?>)</td></tr>
                          <tr><td style="font-size: 65px;">Contenu:<?= $itembags4->contenubagage; ?></td></tr>
                          <tr><td style="font-size: 65px;">Valeur:<?= $itembags4->valeurbagage; ?>FCFA</td></tr>
                          <tr><td style="font-size: 65px;"><b><?= $day4; ?>&nbsp;&nbsp; <?= $heures4; ?></b></td></tr>
                          <tr><td style="font-size: 65px;">Prix:<?= number_format($itembags4->prix_bagage, 0, '', ' '); ?> &nbsp;FCFA </td></tr>
                          <tr><td style="font-size: 40px;">emis : <?= $dtoday4; ?> &nbsp;par <?= $itembags->username; ?> code <?= $itembags4->codebag; ?></td></tr>
                          <tr><td style="font-size: 40px;"><?= $itembags4->nom_compagnie;?> décline toute responsabilité en cas de</td></tr>
                          <tr><td style="font-size: 40px;">perte ou de vol de billet et de bagages même payés.</td></tr>
                          <tr><td style="font-size: 40px;">Suivez et surveillez bien vos bagages</td></tr>
                          <tr><td style="font-size: 50px;">BON VOYAGE AVEC <?= $itembags4->nom_compagnie;?></td></tr>
                        </table>
                    </body>
                </div>
            </div>
...
<!--End of file: pdfepsonbagsuivitrans2.php-->
<!--File location: application/views/beagle/pages/_tickets/pdfepsonbagsuivitrans2.php-->