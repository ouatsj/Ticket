              ...
              <div class="tab-pane active show" id="icon1" role="tabpanel">
                  ...
                  <table>
                        ...
                        if(ticket_est_gratuit($itemtrans3->prixvente)){
                          ...
                          $prfi3 = 'TICKET GRATUIT';
                        }
                        else
                        {
                          $prfi3 = number_format($itemtrans3->prixvente, 0, '', ' ').'FCFA';
                        }
                        
                      
                        $ressougaretra3 = $this->m_gare_depart->getgar($this->entreprise->id_entreprise, $itemtrans3->code_gaexp, $itemtrans3->departclient_idgare, $itemtrans3->ident_ligne, $itemtrans2->id_ligneheure);
                        ...
                        $dtoday = $key.' à '.$dats;
                          ...
                          <tr><td width="25%" style="font-size: 17px;"><?= $itemtrans3->code_ticket; ?></td><td colspan="3" align=left><?= $item->nom_client; ?> <?= $item->prenom_client; ?></td><td style="font-size: 9px;"><?= $itemtrans2->tamponcod; ?> <?= htmlspecialchars(ticket_emis_texte(isset($item) ? $item : null, $dtoday, isset($conex) ? $conex : null), ENT_QUOTES, 'UTF-8'); ?></td>
                          </tr>
                          ...
                          <tr><td align=left><?= $ressougaretra3->nomsousgare; ?></td><td align=left colspan="3" style="font-size: 17px;">AXE:<?= $itemtrans3->nom_ligne; ?></td><td align=left style="font-size: 15px;">QUARTIER:<?= $itemtrans3->quart;?></td>
                          </tr>
                          ...
                          <tr><td align=left><?= $item->nom_client; ?></td><td td colspan="3" align=left>TEL:<?= $item->contact_client; ?></td><td align=left>PRIX:<?=$prfi3;?></td>
                          </tr>
                          <tr><td align=left width="30%"><?= $item->prenom_client; ?></td><td align=center colspan="3"> <?= ticket_barcode_img($itemtrans3->tamponcod, 200, 35); ?></td><td align=left></td>
                          </tr>
                          <tr><td align=left><?= $item->contact_client; ?></td><td colspan="3" align=center style="font-size: 8px;">Billet valable 1 mois. Billet non remboursable</td><td align=left>CONVOCATION 45 mn avant le départ</td>
                          </tr>
                          <tr><td align=left><?=$prfi3;?> <?= $nge3;?></td><td colspan="3" align="center" style="font-size: 9px;"><?= $itemtrans2->nom_compagnie;?> décline toute responsabilité en cas de perte ou de vol de billet et de bagages même payés.</td>
                          </tr>
                          ...
                          <tr><td align=left style="font-size: 9px;"></td><td colspan="3" align=center style="font-size: 9px;">BON VOYAGE AVEC <?= $itemtrans3->nom_compagnie;?>&nbsp;&nbsp;&nbsp;<?= $nge3;?></td>
...
<!--End of file: editpdftransfi3.php-->
<!--File location: application/views/beagle/pages/_tickets/editpdftransfi3.php-->