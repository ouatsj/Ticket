                ...
                <table>
                      ...
                      $day = $dat[2]. '-'. $dat[1]. '-' .$dat[0];?>
                        ...
                        <tr><td style="font-size: 20px;"><b><?= "{$item->tamponcod}"; ?></b></td></tr>
          						  ...
          						  <tr><td style="font-size: 20px;"> <tr><td style="font-size: 20px;"><?= "{$item->nom_gaep}"; ?> <?= "{$ressougare->nomsousgare}"; ?>-<?= ticket_destination_label($item); ?> <?= "{$item->quart}"; ?></td></tr>
          						  <tr><td style="font-size: 20px;"><?= $item->nom_client; ?>&nbsp; <?= $item->prenom_client; ?></td></tr>
          						  <tr><td style="font-size: 20px;"><b><?= "{$day}"; ?>&nbsp; <?= "{$heures}"; ?></b></td></tr>
          						  ...
          						  <tr><td>NON REPROGRAMMABLE</td></tr>
                        </table>
                    </body>
                </div>
            </div>
...
<!--End of file: editepreport.php-->
<!--File location: application/views/beagle/pages/_tickets/editepreport.php-->