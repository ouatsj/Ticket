                    ...
                    <body>
                      ...
                      <table>
                        ...
                        if($ressougare4->possitiongare === 'Apres'){
                          ...
                          ?>
                          <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($itembags4->logo);?>" width="300" height=""></td></tr>
                          <tr><td style="font-size: 20px;"><b>Reçu N° : <?= str_pad($itembags4->id_bagage, 3, "0", STR_PAD_LEFT); ?></b></td></tr>
                          <tr><td style="font-size: 20px;"><?= "{$itembags4->nom_gaep}"; ?> <?= "{$ressougare4->nomsousgare}"; ?>-<?= "{$itembags4->nom_gadest}"; ?></td></tr>
                          <tr><td style="font-size: 20px;">Contact exp:<?= $itembags4->contactexpedi; ?> <?= $itembags4->genrebagage; ?></td></tr>
                          <tr><td style="font-size: 20px;">Contact dest:<?= $itembags4->contact_client; ?></td></tr>
                          <tr><td style="font-size: 20px;"> <?= $itembags4->nom_client; ?> <?= $itembags4->prenom_client; ?></td></tr>
                          <tr><td style="font-size: 20px;">Nombre bagage:<?= $itembags4->nombrebagage; ?>&nbsp;(<?=$itembags4->typebagages; ?>)</td></tr>
                          <tr><td style="font-size: 20px;">Contenu:<?= $itembags4->contenubagage; ?></td></tr>
                          <tr><td style="font-size: 20px;">Valeur:<?= $itembags4->valeurbagage; ?>FCFA</td></tr>
                          <tr><td style="font-size: 20px;"><b><?= $day4; ?>&nbsp;&nbsp; <?= $heures4; ?></b></td></tr>
                          <tr><td style="font-size: 20px;">Prix:<?= number_format($itembags4->prix_bagage, 0, '', ' '); ?> &nbsp;FCFA </td></tr>
                          <tr><td style="font-size: 15px;">emis : <?= $dtoday4; ?> &nbsp;par <?= $itembags4->username; ?> code <?= $itembags4->codebag; ?></td></tr>
                          <tr><td style="font-size: 15px;"><?= $itembags4->nom_compagnie;?> décline toute responsabilité en cas de</td></tr>
                        <tr><td style="font-size: 15px;">perte ou de vol de billet et de bagages même payés.</td></tr>
                        <tr><td style="font-size: 15px;">Suivez et surveillez bien vos bagages</td></tr>
                        <tr><td style="font-size: 20px;">BON VOYAGE AVEC <?= $itembags4->nom_compagnie;?></td></tr>
                        </table>
                    </body>
                </div>
            </div>
...
<!--End of file: pdfepsonbagsuivitransg2.php-->
<!--File location: application/views/beagle/pages/_tickets/pdfepsonbagsuivitransg2.php-->