            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                        ...
                        ?>
                        <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($item->logo);?>" width="300" height=""></td></tr>
                          <tr><td style="font-size: 30px;">RETOUR</td></tr>
                          <tr><td style="font-size: 30px;"><?= "{$itemar->codeticket}"; ?></td></tr>
                          <tr><td style="font-size: 30px;"><?= "{$item->nom_gadest}"; ?>-<?= "{$item->nom_gaep}"; ?></td></tr>
                          ...
                          <tr><td style="font-size: 30px;"><?=$pri; ?></td></tr>
                          <tr><td style="font-size: 30px;"><?= "{$item->contact_client}"; ?></td></tr>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          <tr><td style="font-size: 20px;"><?=$pr; ?> &nbsp;<?= "{$item->contact_client}"; ?></td></tr>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          if($ressougaretra->possitiongare === 'Maintenant'){
                            ...
                            <tr><td style="font-size: 20px;"><?= $item->nom_client; ?> &nbsp;<?= $item->prenom_client; ?></td></tr>
                            <tr><td style="font-size: 20px;"><b><?= "{$day1}"; ?> &nbsp;<?= $heures1; ?></td></tr>
                          ...
                          if($ressougaretra2->possitiongare === 'Maintenant'){
                            ...
                            $dtoday = $key.' à '.$dats;
                              ...
                              if($itemtrans2->gareidentif === 'OUA12')
                              {
                                 ...
                                 $dx2 = explode($itemtrans2->gareidentif, $cx2);
                                 $x2 = $dx2[1];
                              }
                              else
                              {
...
<!--End of file: editpdfepsontransarfi2.php-->
<!--File location: application/views/beagle/pages/_tickets/editpdfepsontransarfi2.php-->