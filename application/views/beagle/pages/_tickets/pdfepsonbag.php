            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                        ...
                        <tr><td style="font-size: 65px;">Contact exp:<?= $itembag->contactexpedi; ?> <?= $itembag->genrebagage; ?></td></tr>
                        <tr><td style="font-size: 65px;">Nombre bagage&nbsp;:&nbsp;<b><?= $itembag->nombrebagage; ?>&nbsp;(<?=$itembag->typebagages; ?>)</b></td></tr>
                        <tr><td style="font-size: 60px;">Contenu:<?= $itembag->contenubagage; ?></td></tr>
                        
                        <tr><td style="font-size: 65px;">Valeur:<?= $itembag->valeurbagage; ?>&nbsp;FCFA</td></tr>
                        <tr><td style="font-size: 65px;"><b><?= $day; ?>&nbsp;&nbsp; <?= $heures; ?></b></td></tr>
                        <tr><td style="font-size: 65px;">Siege: <?= str_pad($itembag->num_siege_categorie, 2, "0", STR_PAD_LEFT); ?><b>&nbsp;&nbsp;&nbsp;<?= number_format($itembag->prix_bagage, 0, '', ' '); ?> &nbsp;FCFA </td></tr>
...
<!--End of file: pdfepsonbag.php-->
<!--File location: application/views/beagle/pages/_tickets/pdfepsonbag.php-->