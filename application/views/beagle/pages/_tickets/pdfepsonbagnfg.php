            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                        ...
                        <tr><td style="font-size: 20px;">Nombre bagage:<?= $itembag->nombrebagage; ?>&nbsp;(<?= $itembag->typebagages; ?>)</b></td></tr>
                        ...
                        <tr><td style="font-size: 20px;">Siege: <?= str_pad($itembag->num_siege_categorie, 2, "0", STR_PAD_LEFT); ?><b></td></tr>
...
<!--End of file: pdfepsonbagnfg.php-->
<!--File location: application/views/beagle/pages/_tickets/pdfepsonbagnfg.php-->