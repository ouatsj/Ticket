                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                            ...
                            if ($this->session->agent->userole === '1' OR $this->session->agent->userole === '2'){
                                  $reponse = $this->m_passager->getad($this->entreprise->ekey, $item->tamponcod, $item->id_ligneheure);
                                  $fiche = $this->m_non_passager->getad($this->entreprise->ekey, $itemar->code_non_pass);
                            }
                            else
                            {
                                  $reponse = $this->m_passager->get($this->entreprise->ekey, $item->tamponcod, $item->id_ligneheure);
                                  $fiche = $this->m_non_passager->getad($this->entreprise->ekey, $itemar->code_non_pass);
                            }
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          $reponsetrans = $this->m_passager->get($this->entreprise->ekey, $itemtrans->tamponcod, $itemtrans->id_ligneheure);
...
<!--End of file: editpdftransar.php-->
<!--File location: application/views/beagle/pages/_tickets/editpdftransar.php-->