                      ...
                      <table>
                          ...
                          $this->entreprise = $this->m_entreprises->get_key($ckey);
                            ...
                            <tr><td style="font-size: 55px; width: 50%;"> <img src="<?echo site_url($item->logo);?>" width="300" height=""></td></tr>
              					...
              					<tr><td style="font-size: 20px;">Prix:<?= $pr; ?> &nbsp; &nbsp;<?= "{$item->contact_client}"; ?></td></tr>
                        <? ;  $uppass = array(
                                'reimprime' => 1,
                              );
                              
                              $this->m_passager->update($item->code_passager, $item->code_ticket, $uppass);
                        ?>
                        </table>
                    </body>
                </div>
...
<div class="saut-page"></div>
  <? endforeach; ?>
<!--End of file: reditpdfepsonfigr.php-->
<!--File location: application/views/beagle/pages/_tickets/reditpdfepsonfigr.php-->