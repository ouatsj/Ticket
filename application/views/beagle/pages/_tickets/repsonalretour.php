<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
  ...
  <? foreach ($tritem as $itemc): ?>
      <?
        ...
        $ckey = $this->session->company->ekey;
          ...
          $item = $this->m_passager->get($this->entreprise->ekey, $itemc->tamponcod, $itemc->typetarif, $itemc->id_heur);
          

          $ritem = $this->m_non_passager->gettr($this->entreprise->ekey, $itemc->tamponcod);
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          ?>
                                ...
                                <tr><td style="font-size: 20px;"><b><?= "{$ritem->codeticket}"; ?></b></td></tr>
  ...
  <div class="saut-page"></div>
  <? endforeach; ?>
<!--End of file: repsonalretour.php-->
<!--File location: application/views/beagle/pages/_tickets/repsonalretour.php-->