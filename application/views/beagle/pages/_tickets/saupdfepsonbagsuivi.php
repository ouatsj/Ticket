        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active show" id="icon1" role="tabpanel">
                ...
                <table>
                    ...
                    <tr><td style="font-size: 65px;">Facturer le <b><?= $day;?></b></td></tr>
...
<!--End of file: saupdfepsonbagsuivi.php-->
<!--File location: application/views/beagle/pages/_tickets/saupdfepsonbagsuivi.php-->