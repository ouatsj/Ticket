                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          if($ressougaretra->possitiongare === 'Maintenant'){
                            ...
                            <tr><td align=left><?= $ressougaretra->nomsousgare; ?></td><td align=left colspan="2" style="font-size: 10px;"></td><td align=center style="font-size: 12px;">PRIX:<?= number_format($itemtrans->prix+$itemtrans->prix, 0, '', ' ');?>FCFA</td><td align=left style="font-size: 15px;"><?= $ressougaretra->nomsousgare; ?>:<?= $day1;?></td><td align=left style="font-size: 15px;">DATE:</td>
                            </tr>
                            ...
                            <tr><td align=left><?= number_format($itemtrans->prix+$itemtrans->prix, 0, '', ' ');?> FCFA <?= $codb1;?></td><td colspan="3" align="center" style="font-size: 9px;"><?= $itemtrans->nom_compagnie;?> décline toute responsabilité en cas de perte ou de vol de billet et de bagages même payés.</td>
                            </tr>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          if($ressougaretra2->possitiongare === 'Maintenant'){
                            ...
                            <tr><td align=left><?= $ressougaretra2->nomsousgare; ?></td><td align=left colspan="2" style="font-size: 10px;"></td><td align=center style="font-size: 12px;">PRIX:<?= number_format($itemtrans2->prix+$itemtrans2->prix, 0, '', ' ');?>FCFA</td><td align=left style="font-size: 15px;"><?= $ressougaretra2->nomsousgare; ?>:<?= $day2;?></td><td align=left style="font-size: 15px;">DATE:</td>
                            </tr>
                            ...
                            <tr><td align=left><?= number_format($itemtrans2->prix+$itemtrans2->prix, 0, '', ' ');?> FCFA <?= $codb2;?></td><td colspan="3" align="center" style="font-size: 9px;"><?= $itemtrans2->nom_compagnie;?> décline toute responsabilité en cas de perte ou de vol de billet et de bagages même payés.</td>
                            </tr>
                ...
                <div class="tab-pane active show" id="icon1" role="tabpanel">
                    ...
                    <table>
                          ...
                          if($ressougaretra3->possitiongare === 'Maintenant'){
                            ...
                            <tr><td align=left><?= $ressougaretra3->nomsousgare; ?></td><td align=left colspan="2" style="font-size: 10px;"></td><td align=center style="font-size: 12px;">PRIX:<?= number_format($itemtrans3->prix+$itemtrans3->prix, 0, '', ' ');?>FCFA</td><td align=left style="font-size: 15px;"><?= $ressougaretra3->nomsousgare; ?>:<?= $day3;?></td><td align=left style="font-size: 15px;">DATE:</td>
                            </tr>
                            ...
                            <tr><td align=left><?= number_format($itemtrans3->prix+$itemtrans3->prix, 0, '', ' ');?> FCFA <?= $codb3;?></td><td colspan="3" align="center" style="font-size: 9px;"><?= $itemtrans3->nom_compagnie;?> décline toute responsabilité en cas de perte ou de vol de billet et de bagages même payés.</td>
                            </tr>
                            <tr><td align=left style="font-size: 9px;"><?= $itemtrans3->tamponcod;?></td><td colspan="3" align=center style="font-size: 9px;">Suivez et surveillez bien vos bagages</td>
                            </tr>
