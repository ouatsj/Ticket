<?php
    ...
    <div class="row">
        <p class="mt-0 mb-2 ml-4">
            ...
            <a href="#" class="btn btn-space btn-secondary addverseautre md-trigger" 
                    data-modal="form-autreverse" data-cle_compagnie="<?= $this->session->company->ekey; ?>">
                <i class="fas fa-edit text-success"></i>&nbsp;VERSEMENT CILENT&nbsp;
            </a>
    ...
    <div class="col-12">
        ...
        <div class="card card-table">
            ...
            <div class="card-header">
                ...
                <div class="title">Les versements clients</div>
...
<div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
     id="form-autreverse" style="perspective: none;">
