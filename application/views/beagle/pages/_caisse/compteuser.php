                            ...
                            <td>
                                ...
                                <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <?= form_open('Utilisateurs/validerecette/' . $this->session->company->ekey.'/'. $item->guser.'/'. $item->idsousga.'/'.$item->idusercompt.'/'.$item->idcpguichet, array('class' => 'modal-body form')); ?>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive noSwipe">
                    ...
                    <table class="table table-striped table-hover" id="table3">
                        ...
                        <tbody>
                        <? foreach ($versementscourrier as $item1): ?>
        
                            <tr>
                            <td><?= $item1->nom_compagnie; ?></td>
                            <td><?= $item1->comptdatearret; ?><br><?= $item1->update_lastcptg; ?></td>
                            <td><?= $item1->comptemont;?></td>
                            <td>
                                <a href="<?= "#?&&&"; ?>"
                                        class="md-trigger" data-modal="recetvalid-<?= $item1->idcpcourrier ; ?>">
                                        <span class="fas fa-edit text-warning"></span>
                                </a>

                                <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                                    id="recetvalid-<?= $item1->idcpcourrier ; ?>" style="perspective: none;">

                                    <div class="modal-content">
                                        <div class="modal-header modal-header-colored">
                                            <h3 class="modal-title">VALIDER RECETTE COURRIER DE <?= $item1->first_name;?> <?= $item1->last_name; ?></h3>
                                            <button class="close modal-close" type="button"
                                                data-dismiss="modal" aria-hidden="true"><span
                                                class="mdi mdi-close text-white"></span></button>
                                        </div>
                                        
                                        <?= form_open('Utilisateurs/recettevaliderecet/' . $this->session->company->ekey.'/'. $item1->guser.'/'. $item1->idsousg.'/'. $item1->comptiduser.'/'.$item1->idcpcourrier, array('class' => 'modal-body form')); ?>
                                        
                                        <input type="hidden" name="interne" value="Courrier">
                                                <input type="hidden" name="idgar" value="<?= $caisseident->id_caiss;?>">
                                            <input type="hidden" name="idcompa" value="<?= $item1->compcour; ?>">
                                        <div class="row">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive noSwipe">
                    ...
                    <table class="table table-striped table-hover" id="table1">
                        ...
                        <tbody>
                        <? foreach ($montantversersbag as $item): ?>
                            ...
                            <td>
                                ...
                                <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <?= form_open('Utilisateurs/validerecettebagu/'.$this->session->company->ekey.'/'.$item->guser.'/'.$item->idsousgabg.'/'.$item->idusercomptbg.'/'.$item->idcpguichetbg, array('class' => 'modal-body form')); ?>
