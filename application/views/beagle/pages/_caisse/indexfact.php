            ...
            <p>
               <a href="<?= site_url("caissescourriers/fact/{$this->session->company->ekey}". "/".$conex->roleattribut
                ...
                <a href="#" data-cle_compagnie="<?= $this->session->company->ekey; ?>"
                    class="btn btn-secondary btn-space md-trigger" data-modal="voirfactu-0">
                    <i class="fas fa-edit text-success"></i>&nbsp;TRI FACTURE&nbsp;
                </a>
            </p>
        </div>
    </div>
    ...
    <div class="col-12">
        ...
        <div class="card card-table">
            ...
            <div class="card-header">
                ...
                <div class="title">Toutes les factures</div>
...
<div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
            id="voirfactu-0" style="perspective: none;">

        <div class="modal-content">

            <div class="modal-header modal-header-colored">
                <h3 class="modal-title" id="">VOIR FACTURE</h3>
            ...
            <?= form_open("Caissescourriers/trifactures/{$this->session->company->ekey}/{$bus_stop->idengare}/{$conex->roleattribut}/{$bus_stop->idsousgare}", array('class' => 'modal-body form')); ?>
...
<!--End of file: indexfact.php-->
<!--File location: application/views/beagle/pages/_caissecourrier/indexfact.php-->
