                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input js-ecart-manquant" type="checkbox"
                                                           ...
                                                           id="ecart_manquant_esc-<?= (int) $item->idcpguichet; ?>">
                                                    <label class="custom-control-label" for="ecart_manquant_esc-<?= (int) $item->idcpguichet; ?>">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input js-ecart-surplus" type="checkbox"
                                                           ...
                                                           id="ecart_surplus_esc-<?= (int) $item->idcpguichet; ?>">
                                                    <label class="custom-control-label" for="ecart_surplus_esc-<?= (int) $item->idcpguichet; ?>">
