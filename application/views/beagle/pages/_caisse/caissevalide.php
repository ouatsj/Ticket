            ...
            <div class="card card-border card-contrast">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= site_url('utilisateurs/'
                        ...
                        . $item->guser. '/'. $caisseident->id_caiss. '/'. $item->roleattribut . '/'. $conex->roleattribut .'/' . $bus_stop->idsousgare. '/'.mdate("%d/%m/%Y", now('UTC'))); ?>" class="btn btn-block btn-rounded text-dark bg-info">
