...
<div class="row">
        <p class="mt-0 mb-2 ml-4">
            ...
            <button class="btn btn-space btn-secondary md-trigger" data-cle_compagnie="<?= $this->session->company->ekey; ?>"
                    data-modal="valtrirecette-form">
                <i class="fas fa-edit text-warning"></i>&nbsp;VALIDATION&nbsp;
            </button>
        </p>
</div>
<div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
            id="valtrirecette-form" style="perspective: none;">
    ...
    <div class="modal-content">
        ...
        <?= form_open("Recettes/valrecettess/{$this->session->company->ekey}", array('class' => 'modal-body form')); ?>
        ...
        <div class="row">
            ...
            <input type="hidden" name="_compagrr" value="<?= $cpe; ?>">
            <input type="hidden" name="datedebutsrr" value="<?= $dat1; ?>">
            <input type="hidden" name="datefinsrr" value="<?= $dat2; ?>">
            <input type="hidden" name="iduseconrr" value="<?= $uop; ?>">
            <div class="form-group col-sm-4">
                <label>COMPAGNIE</label>
                <select class="form-control form-control-sm" name="compags">
                <option value=""></option>
                                ...
                                <td>
                                    ...
                                    id="vald-edit-<?= $item->id_recette; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <input type="hidden" name="_compagr" value="<?= $cpe; ?>">
                                            <input type="hidden" name="datedebutsr" value="<?= $dat1; ?>">
                                            <input type="hidden" name="datefinsr" value="<?= $dat2; ?>">
                                            <input type="hidden" name="iduseconr" value="<?= $uop; ?>">
                                                <div class="form-group col-sm-4">
