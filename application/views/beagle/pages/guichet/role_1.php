...
<div class="row">
                <div class="col-sm-12">
                    <?php $this->load->view('beagle/pages/guichet/_accueil_toolbar_role_1'); ?>
                    <?php $this->load->view('beagle/pages/guichet/_etats_fusion_choix'); ?>
                    <?php $this->load->view('beagle/pages/guichet/_accueil_solde_role_1'); ?>
                </div>
            ...
            <div class="row">
                ...
                <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                        id="ticketmobil-0" style="perspective: none">
                        
                        <div class="modal-content">
                            <div class="modal-header modal-header-colored">
                                <h3 class="modal-title" id="mobTitle"></h3>
...
<div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label style="display:block" id="iddepmob">Départ</label>
                                        <select style="display:block" class="form-control form-control-sm" name="depargaremob" id="depargaremob">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label style="display:block" id="arridmob">Arrivée</label>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label style="display:block" id="idquartmob">Quartier</label>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label style="display:block" id="hridmob">Heure</label>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label style="display:block;" id="sigidmob">Siège</label>
                                ...
                                <div class="form-group row">
                                    <div class="modal-footer">
                                        ...
                                        <input class="btn btn-success md-trigger" type="submit" name="epsonmob" value="IMPRIMER">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input class="form-control form-control-sm" type="date" name="date_docfi" value="<?= mdate("%Y-%m-%d", now());?>"
                            ...
                            <div class="form-group row">
                                <div class="modal-footer">
                                    ...
                                    <input class="btn btn-success md-trigger" type="submit" name="ordinaire" value="ORDINAIRE" disabled="">
                                    <input class="btn btn-success md-trigger" type="submit" name="espon" value="EPSON" id="bottontickfi">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="card-header text-center">Information sur le depart </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <div class="d-flex align-items-center flex-wrap mb-1">
                                            <label class="mb-0 mr-2" id="hridfid">Heure</label>
...
<div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label style="display:none" id="arritin3fid">Correspondance 4 — ligne</label>
...
<div class="form-group col-sm-4">
               ...
               <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                ...
                <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-sm-4">
                                <label>DU</label>
                                <input class="form-control form-control-sm" type="date" name="dated" id="iddatedebut">
                            </div>
                            <div class="form-group col-sm-4">
                                <label>AU</label>
                                <input class="form-control form-control-sm" type="date" name="datef" id="iddatefin">
                            </div>
                            <div class="form-group col-sm-4">
                                <label>OPERATEUR</label>
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <select class="form-control form-control-sm" name="caissier" id="idcaissiers">
                                            <option value="">Choississez Guichetiers</option>
                ...
                <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                    ...
                    <div class="modal-content">
                        <div class="modal-header modal-header-colored">
                            <h3 class="modal-title" id="caiTitle">TRI DES ETATS DE VERSEMENT</h3>
                            <button class="close modal-close" type="button"
                                    data-dismiss="modal" aria-hidden="true"><span
                                    class="mdi mdi-close text-white"></span>
                            </button>
