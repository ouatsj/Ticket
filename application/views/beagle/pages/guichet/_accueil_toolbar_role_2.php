...
<div class="guichet-accueil-toolbar card card-border-color card-border-color-primary mb-3">
  <div class="card-body p-2">
    ...
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#guichet-tab-2-tickets" role="tab" aria-selected="false"><i class="fas fa-ticket-alt mr-1"></i>Tickets</a></li>
      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#guichet-tab-2-caisse" role="tab" aria-selected="false"><i class="fas fa-cash-register mr-1"></i>Caisse</a></li>
      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#guichet-tab-2-consultation" role="tab" aria-selected="false"><i class="fas fa-eye mr-1"></i>Consultation</a></li>
      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#guichet-tab-2-bagages" role="tab" aria-selected="false"><i class="fas fa-suitcase mr-1"></i>Bagages & escales</a></li>
      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#guichet-tab-2-rapports" role="tab" aria-selected="false"><i class="fas fa-chart-bar mr-1"></i>Rapports</a></li>
      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#guichet-tab-2-declarations" role="tab" aria-selected="false"><i class="fas fa-file-signature mr-1"></i>Déclarations</a></li>
      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#guichet-tab-2-admin" role="tab" aria-selected="false"><i class="fas fa-cogs mr-1"></i>Administration</a></li>
    </ul>
    <div class="tab-content pt-3">
      <div class="tab-pane fade show active" id="guichet-tab-2-vente" role="tabpanel">
      ...
      <div class="tab-pane fade" id="guichet-tab-2-caisse" role="tabpanel">
        <div class="guichet-btn-grid">
      ...
      <div class="tab-pane fade" id="guichet-tab-2-bagages" role="tabpanel">
        <div class="guichet-btn-grid">
      ...
      <div class="tab-pane fade" id="guichet-tab-2-rapports" role="tabpanel">
        <div class="guichet-btn-grid">
      ...
      <div class="tab-pane fade" id="guichet-tab-2-declarations" role="tabpanel">
        <div class="guichet-btn-grid">
          <button class="btn btn-secondary btn-space md-trigger"
      ...
      <div class="tab-pane fade" id="guichet-tab-2-admin" role="tabpanel">
        <div class="guichet-btn-grid">
          <button class="btn btn-secondary btn-space md-trigger"
