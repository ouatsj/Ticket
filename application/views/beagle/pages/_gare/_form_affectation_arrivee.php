...
<div class="form-group">
    ...
    <select name="compgare" class="form-control form-control-sm" required>
...
<div class="form-group">
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="mode-affecter-arr-<?= htmlspecialchars($modal_suffix, ENT_QUOTES, 'UTF-8'); ?>"
               name="mode_affectation" value="affecter" class="custom-control-input" checked>
        <label class="custom-control-label" for="mode-affecter-arr-<?= htmlspecialchars($modal_suffix, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <div class="custom-control custom-radio mt-2">
        <input type="radio" id="mode-creer-arr-<?= htmlspecialchars($modal_suffix, ENT_QUOTES, 'UTF-8'); ?>"
               name="mode_affectation" value="creer" class="custom-control-input">
        <label class="custom-control-label" for="mode-creer-arr-<?= htmlspecialchars($modal_suffix, ENT_QUOTES, 'UTF-8'); ?>">
...
<div class="form-group js-mode-affecter">
    ...
    <select name="gareselected" class="form-control form-control-sm js-gare-physique" required>
...
<div class="row">
    <div class="form-group col-sm-6 js-mode-creer" style="display:none;">
        ...
        <select name="villegare" class="form-control form-control-sm js-gare-ville">
