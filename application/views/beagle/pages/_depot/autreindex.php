                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="row">
                                               ...
                                               <input type="hidden" name="idcaisse" value="<?= $caisseident->id_caiss; ?>">
												...
												<div class="form-group col-sm-4">
													<label>DATE</label>
													<input class="form-control form-control-sm" type="date" name="datedepot" value="<?= !empty($alldepots->datedepot) ? date('Y-m-d', strtotime($alldepots->datedepot)) : ''; ?>">
												</div>
                                            </div>
...
<div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
    ...
    <!-- End of file: autreindex.php -->
    <!-- File location: application/views/beagle/pages/_depot/autreindex.php -->