...
<div class="row">
    <p class="mt-0 mb-2 ml-4">
        ...
        <button class="btn btn-space btn-secondary addepotfour md-trigger"
                data-modal="form-autrefrdepot" data-cle_compagnie="<?= $this->session->company->ekey; ?>">
            <i class="fas fa-edit text-warning"></i>&nbsp;DEPOT FOURNISSEUR&nbsp;
        </button>
                                ...
                                <td>
                                    ...
                                    <div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <?= form_open("Depots/updatefour/{$this->session->company->ekey}/{$alldepots->id_depot}",
...
<div class="modal-container colored-header colored-header-success custom-width modal-effect-7"
     id="form-autrefrdepot" style="perspective: none;">

    <div class="modal-content">
        <div class="modal-header modal-header-colored">
            <h3 class="modal-title" id="fourTitle"></h3>
            <button class="close modal-close" type="button"
                    data-dismiss="modal" aria-hidden="true"><span
        ...
        <? if($sommerecettes == NULL):?><?$r=0;?><? else:?><? $r = $sommerecettes->montant_recet;?><?endif;?>
            <? if($sommedepenses == NULL):?><?$d=0;?><? else:?><? $d = $sommedepenses->montant_depens;?><?endif;?>
                <? if($sommedepot == NULL):?><?$dp=0;?><? else:?><? $dp = $sommedepot->montant_depot;?><?endif;?>
                    <? $solde = ($dp+$r)-($v+$d);?>
        <?= form_open("" , array('class' => 'modal-body form', 'id' => 'frdepot')); ?>
    ...
    <!-- End of file: fourdepot.php -->
    <!-- File location: application/views/beagle/pages/_depot/fourdepot.php -->