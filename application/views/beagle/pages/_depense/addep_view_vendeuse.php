    ...
    <p class="mt-0 mb-2 ml-4">
        ...
        <a href="<?= site_url("caisses/{$this->session->company->ekey}". "/gTv/".
                    (!empty($caisseident->gexp_caiss) ? $caisseident->gexp_caiss : 0). "/".(!empty($caisseident->id_caiss) ? $caisseident->id_caiss : 0).
                        "/depense/" . $conex->roleattribut.'/'.$bus_stop->idsousgare.'/'.  mdate("%d/%m/%Y", now('UTC'))); ?>" class="btn btn-space btn-secondary">
                <i class="fas fa-arrow-circle-up text-success"></i>&nbsp;DEPENSES&nbsp;
            ...
            <div class="card card-border card-contrast">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= site_url('utilisateurs/'
                        . $this->session->company->ekey . '/profilsdep/'
...
<!--End of file: addep_view_vendeuse.php-->
<!--File location: application/views/beagle/pages/_depense/addep_view_vendeuse.php-->                            